...
# This If is needed to handle Matplotlib/Tkinter threading as per
...
if __name__ == "__main__":
    ...
    loky_results = batch_simulation.run(
        param_grid,
        n_jobs=n_jobs,
        combinations=False,
        backend='loky',
    ...
    try:
        ...
        print("Dask not installed. Run: pip install \"hnn-core[parallel]\"")
