...
# Distal
weights_ampa_d1 = {'L2_basket': 0.8037, 'L2_pyramidal': 0.5738, 'L5_pyramidal': 0.3626}
weights_nmda_d1 = {'L2_basket': 0.2492, 'L2_pyramidal': 0.6183, 'L5_pyramidal': 0.1121}
...
def set_params(net, params):
    ...
    # Proximal 2
    weights_ampa_p2 = {
        'L2_basket': params['evprox2_ampa_L2_basket'],
    ...
    weights_nmda_p2 = {
        'L2_basket': params['evprox2_nmda_L2_basket'],
...
constraints = dict(
    {
        'evprox2_ampa_L2_basket': (0.01, 1.0),
        'evprox2_ampa_L2_pyramidal': (0.01, 1.0),
        'evprox2_ampa_L5_basket': (0.01, 1.0),
        'evprox2_ampa_L5_pyramidal': (0.01, 1.0),
        'evprox2_nmda_L2_basket': (0.01, 1.0),
        'evprox2_nmda_L2_pyramidal': (0.01, 1.0),
        'evprox2_nmda_L5_basket': (0.01, 1.0),
        'evprox2_nmda_L5_pyramidal': (0.01, 1.0),
        'evprox2_mu': (100.0, 120.0),
        'evprox2_sigma': (2.0, 30.0),
    }
)
...
optim = Optimizer(net, tstop=tstop, constraints=constraints, set_params=set_params)
with MPIBackend(n_procs=n_procs, mpi_cmd='mpiexec'):
    optim.fit(
        target=exp_dpl, scale_factor=scale_factor, smooth_window_len=smooth_window_len
    )
