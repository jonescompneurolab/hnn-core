...
net.add_bursty_drive(
    'beta_dist', tstart=beta_start, burst_rate=1e-10, burst_std=10.,
...
net.add_evoked_drive(
    'evdist1', mu=63.53 + erp_start, sigma=3.85, numspikes=1,
...
net.add_evoked_drive(
    'evprox1', mu=26.61 + erp_start, sigma=2.47, numspikes=1,
...
net.add_evoked_drive(
    'evprox2', mu=137.12 + erp_start, sigma=8.33, numspikes=1,
...
plot_dipole(dpls, ax=axes[0], layer='agg', tmin=5.0, show=False)
