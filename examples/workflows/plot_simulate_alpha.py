...
dpl = simulate_dipole(net, tstop=310.0, n_trials=1)
...
plot_psd(dpl[trial_idx], fmin=1.0, fmax=1e3, tmin=tmin, ax=axes[1], show=False)
...
dpl[trial_idx].plot_psd(fmin=0.0, fmax=40.0, tmin=tmin, ax=axes[2])
plt.tight_layout()
