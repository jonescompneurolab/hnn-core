...
class NetworkBuilder(object):
    ...
    def state_init(self):
        ...
        for cell in self.cells:
            ...
            for sect in seclist:
                for iseg, seg in enumerate(sect):
                    if cell.celltype == 'L2_pyramidal':
                        # seg.v = -71.46
                        if 'L2Pyr_soma' in sect.name():
                            seg.v = seg_vs['L2Pyr_soma'][0]
                        else:
                            seg.v = seg_vs[sect.name()][iseg]
                        ...
                        # else:
                        #     seg.v = -72.
                        if 'L5Pyr_soma' in sect.name():
                            seg.v = seg_vs['L5Pyr_soma'][0]
                        else:
                            seg.v = seg_vs[sect.name()][iseg]
