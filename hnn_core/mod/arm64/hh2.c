...
#define _f_rates _f_rates__hh2 
#define rates rates__hh2 
...
#define temp temp_hh2
 double temp = 6.3;
#define tshift tshift_hh2
 double tshift = 30.7;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 6, "cvodeieq");
 	...
 	ivoc_help("help ?1 hh2 /Users/katharinaduecker/Documents/projects_brown/hnn-tuning/local_hnn/hnn_core/mod/hh2.mod\n");
...
static int _reset;
static char *modelname = "hh2.mod   sodium, potassium, and leak channels";
...
static int  _f_rates ( _threadargsprotocomma_ double _lv ) {
  ...
  _lq10 = pow( 3.0 , ( ( celsius - temp - tshift ) / 10.0 ) ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/katharinaduecker/Documents/projects_brown/hnn-tuning/local_hnn/hnn_core/mod/hh2.mod";
static const char* nmodl_file_text = 
