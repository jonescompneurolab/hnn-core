...
def get_L2Pyr_params_new():
    ...
    return {# Soma
        ...
        # Biophysics soma
        'L2Pyr_soma_gbar_NaTs2_t_32d': 20_400e-4,
        'L2Pyr_soma_gbar_SKv3_1': 6_930e-4,
        'L2Pyr_soma_gbar_Nap_Et2': 1e-4/2,
        'L2Pyr_soma_gbar_SK_E2': 0.099433/2*0.001,
        'L2Pyr_soma_gbar_Ca_HVA': 9.92e-04/2,
        'L2Pyr_soma_gbar_Ca_LVAst': 34.3e-4/2*1.5,
        'L2Pyr_soma_gbar_Ih': 0.000080/2*3,
        'L2Pyr_soma_gbar_Im': 8e-3/2,
        'L2Pyr_soma_g_pas': 1.0 / 12000.0,
        'L2Pyr_soma_e_pas': -85,
        'L2Pyr_soma_decay_CaDynamics_E2' : 342.544232,
        'L2Pyr_soma_gamma_CaDynamics_E2' : 0.000533,

        # Biophysics basal
        'L2Pyr_basal_gbar_NaTa_t_32d': 0.008009/2,
        'L2Pyr_basal_gbar_SKv3_1': 6_930e-4*0.1,
        'L2Pyr_basal_gbar_Ih': 0.000080,
        'L2Pyr_basal_g_pas': 8.333333333333333e-05,           # default read out from neuron
        'L2Pyr_basal_e_pas': -85, 

        # Biophysics dends
        'L2Pyr_dend_gbar_NaTa_t_32d': 0.008009/2,
        'L2Pyr_dend_gbar_SKv3_1': 0.000513/2,
        'L2Pyr_dend_gbar_Ca_HVA': 0.000374e-2/2,
        'L2Pyr_dend_gbar_Ca_LVAst': 0.000778e-2/2,
        'L2Pyr_dend_gbar_Ih': 0.000080*5/2,
        'L2Pyr_dend_gbar_Im': 8e-3/2,
        'L2Pyr_dend_g_pas': 1.0 / 12000.0/2,
        'L2Pyr_dend_e_pas': -85}
...
def get_L5Pyr_params_new():
    ...
    return {
        ...
        # Biophysics soma
        'L5Pyr_soma_gbar_NaTs2_t': 20_400e-4/2,
        'L5Pyr_soma_gbar_SKv3_1': 6_930e-4/2,
        'L5Pyr_soma_gbar_Nap_Et2': 17.2e-4/2,
        'L5Pyr_soma_gbar_SK_E2': 441e-4*3,
        ...
        'L5Pyr_dend_gbar_SK_E2': 0.0012/2,
...
def get_Int_params():
    ...
    return {'Int_gbar_nas': 0.1125*1.2,
            'Int_gbar_kdr': 0.225,
            'Int_gbar_kd':  0.00039*10,
            'Int_gbar_Ih':  2e-3,
            'Int_g_pas': .0001,
            'Int_e_pas': -70}