...
def get_L5Pyr_params_default():
    ...
    return {
        ...
        "L5Pyr_ampa_tau1": 0.5,
        "L5Pyr_ampa_tau2": 5.0,
        "L5Pyr_ampa_mechname": "Exp2Syn",
        "L5Pyr_nmda_e": 0.0,
        "L5Pyr_nmda_tau1": 1.0,
        "L5Pyr_nmda_tau2": 20.0,
        "L5Pyr_nmda_mechname": "Exp2Syn",
        "L5Pyr_gabaa_e": -80.0,
        "L5Pyr_gabaa_tau1": 0.5,
        "L5Pyr_gabaa_tau2": 5.0,
        "L5Pyr_gabaa_mechname": "Exp2Syn",
        "L5Pyr_gabab_e": -80.0,
        "L5Pyr_gabab_tau1": 1.0,
        "L5Pyr_gabab_tau2": 20.0,
        "L5Pyr_gabab_mechname": "Exp2Syn",
        # Biophysics soma
...
def get_L2Pyrhuman_params():
    return {  # Soma
        ...
        "L2Pyr_soma_gbar_Nap_Et2_hay2011": 0,
        "L2Pyr_soma_gbar_SK_E2_hay2011": 3.0e-05,
        "L2Pyr_soma_gbar_Ca_HVA_hay2011": 9.92e-04,
        "L2Pyr_soma_gbar_Ca_LVAst_hay2011": 34.3e-4,
        "L2Pyr_soma_gbar_Ih_hay2011": 2e-05,
        ...
        "L2Pyr_dend_gbar_Ca_HVA_hay2011": 0.00001,
        "L2Pyr_dend_gbar_Ca_LVAst_hay2011": 0.0000001,
        "L2Pyr_dend_gbar_Ih_hay2011": 4e-5,
        "L2Pyr_dend_gbar_Im_hay2011": 9e-08,
...
def get_L5PyrET_params():
    return {
        ...
        "L5Pyr_ampa_mechname": "Exp2Syn",
        "L5Pyr_nmda_e": 0.0,
        "L5Pyr_nmda_mechname": "NMDA_gao2021",
        "L5Pyr_gabaa_e": -80.0,
        "L5Pyr_gabaa_tau1": 0.5,
        "L5Pyr_gabaa_tau2": 5.0,
        "L5Pyr_gabaa_mechname": "Exp2Syn",
        "L5Pyr_gabaa_slow_e": -80.0,
        "L5Pyr_gabaa_slow_tau1": 1.5,
        "L5Pyr_gabaa_slow_tau2": 20.0,
        "L5Pyr_gabaa_slow_mechname": "Exp2Syn",
        "L5Pyr_gabab_mechname": "gabab_neymotin2016",
        # Biophysics soma
        "L5Pyr_soma_gbar_NaTs2_t_hay2011": 1.53,
        "L5Pyr_soma_gbar_SKv3_1_hay2011": 0.3465,
        "L5Pyr_soma_gbar_Nap_Et2_hay2011": 9.46e-05,
        "L5Pyr_soma_gbar_SK_E2_hay2011": 0.6615,
        "L5Pyr_soma_gbar_Ca_HVA_hay2011": 0.000496,
        "L5Pyr_soma_gbar_Ca_LVAst_hay2011": 0.001715,
        "L5Pyr_soma_gbar_Ih_hay2011": 5e-05,
        "L5Pyr_soma_gbar_Im_hay2011": 1e-4,
        "L5Pyr_soma_gbar_K_Pst_hay2011": 0.001115,
        "L5Pyr_soma_gbar_K_Tst_hay2011": 0.0406,
        "L5Pyr_soma_g_pas": 8.45e-06,
        "L5Pyr_soma_e_pas": -90,
        "L5Pyr_soma_decay_CaDynamics_E2_hay2011": 460,
        "L5Pyr_soma_gamma_CaDynamics_E2_hay2011": 0.000501,  # *1e-10,
        # Biophysics basal
        "L5Pyr_basal_gbar_NaTs2_t_hay2011": 0.0102,
        "L5Pyr_basal_gbar_SKv3_1_hay2011": 0.0001305,
        "L5Pyr_basal_gbar_Ih_hay2011": 2.57e-05,
        "L5Pyr_basal_g_pas": 2.6249999999999998e-05,
        "L5Pyr_basal_e_pas": -90,
        "L5Pyr_basal_decay_CaDynamics_E2_hay2011": 50,
        "L5Pyr_basal_gamma_CaDynamics_E2_hay2011": 0.0005096,
        # Biophysics dends
        "L5Pyr_dend_gbar_NaTa_t_hay2011": 0.01065,
        "L5Pyr_dend_gbar_SKv3_1_hay2011": 0.000261,
        "L5Pyr_dend_gbar_SK_E2_hay2011": 0.0036,
        "L5Pyr_dend_gbar_Ca_HVA_hay2011": 1.39e-05,
        "L5Pyr_dend_gbar_Ca_LVAst_hay2011": 4.675e-05,
        "L5Pyr_dend_gbar_Ih_hay2011": 6e-05,
        "L5Pyr_dend_gbar_Im_hay2011": 3.375e-05,
        "L5Pyr_dend_gbar_K_Pst_hay2011": 0,
        "L5Pyr_dend_gbar_K_Tst_hay2011": 0,
        "L5Pyr_dend_g_pas": 3.926666666666667e-05,
        "L5Pyr_dend_e_pas": -85,
        "L5Pyr_dend_decay_CaDynamics_E2_hay2011": 122,
        "L5Pyr_dend_gamma_CaDynamics_E2_hay2011": 0.0005096,
    }
...
def get_Int_params():
    return {
        ...
        "Int_nmda_e": 0.0,
        "Int_nmda_mechname": "NMDA_gao2021",
        "Int_gabaa_e": -80.0,
        "Int_gabaa_tau1": 0.5,
        "Int_gabaa_tau2": 5.0,
        "Int_gabaa_mechname": "Exp2Syn",
        "Int_gabab_mechname": "gabab_neymotin2016",
    }
