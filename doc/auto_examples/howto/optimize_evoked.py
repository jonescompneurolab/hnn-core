...
###############################################################################
# Now we can plot the pre- and post-optimization simulations alongside the
# experimental data.
...
# As an example, we will look at the new dynamics, and synaptic weight 
# of the layer 2/3 AMPA receptors, for the first proximal drive.

from hnn_core.network import pick_connection

dynamics_opt = net_opt.external_drives['evdist1']['dynamics']

conn_indices = pick_connection(net=net_opt, src_gids='evprox1', target_gids='L2_basket',
