...
- Add ability to simulate a single trial in parallel using MPI, by `Blake Caldwell`_ in `#79 <https://github.com/hnnsolver/hnn-core/pull/79>`_
...
- Fix missing autapses in network construction, by `Mainak Jas`_ in `#50 <https://github.com/hnnsolver/hnn-core/pull/50>`_
